...
#     try:
#         reservation_id = create_reservation(headers, vehicle_obj.id)
...
#         reservation_id_a = create_reservation(headers, vehicle_obj.id)
